...
const PremiumShowcaseSection = ({ onLeadFormOpen }: PremiumShowcaseSectionProps) => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-luxury-navy via-luxury-charcoal to-black text-white relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-40 h-40 bg-luxury-gold/10 rounded-full blur-3xl animate-float"></div>
      <div className="absolute bottom-20 left-10 w-60 h-60 bg-luxury-gold/5 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {achievements.map((achievement, index) => {
            ...
            return (
              <Card 
                key={index}
                className="p-6 text-center bg-white/5 border-white/10 hover:bg-white/10 transition-all duration-500 hover:scale-105 animate-scale-in backdrop-blur-sm"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-in-right">
            <Card className="p-8 bg-gradient-to-br from-white/10 to-white/5 border-white/20 backdrop-blur-sm">
