    ...
    <section className="py-16 bg-luxury-cream">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 animate-scale-in" style={{animationDelay: '0.3s'}}>
          <Card className="inline-block p-6 luxury-gradient text-white shadow-luxury">
            <Shield className="w-12 h-12 mx-auto mb-3 text-luxury-gold" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {usps.map((usp, index) => (
            <Card 
              key={index}
              className="p-6 shadow-card hover:shadow-luxury transition-all duration-300 hover:scale-105 animate-fade-in-up"
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-montserrat font-semibold mb-2">{usp.title}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Builder Info */}
          <Card className="p-8 shadow-luxury animate-slide-in-right">
            <div className="text-center mb-6">
              <Building className="w-16 h-16 text-luxury-gold mx-auto mb-4" />
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-luxury-gold">50+</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Happy Families</span>
                <span className="font-bold text-luxury-gold">5,000+</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Sq.Ft Delivered</span>
                <span className="font-bold text-luxury-gold">2.5M+</span>
              </div>
              <div className="flex justify-between items-center">
                <span>Years of Excellence</span>
                <span className="font-bold text-luxury-gold">25+</span>
              </div>
            </div>
          </Card>

          {/* Awards & Recognition */}
          <Card className="p-8 shadow-card animate-fade-in-up" style={{animationDelay: '0.6s'}}>
            <div className="text-center mb-6">
            ...
            <div className="space-y-3">
              {awards.map((award, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 bg-luxury-cream rounded-lg">
                  <Award className="w-5 h-5 text-luxury-gold flex-shrink-0" />
                  <span className="text-sm font-medium">{award}</span>
                </div>
              ))}
            </div>

            <div className="mt-6 p-4 luxury-gradient text-white rounded-lg text-center">
